          ...
          <header class="p-2">
               ...
               <div class="card-body text-justify">
                ...
                <div class="freedays">
                  ...
                  <div v-for="item in filterDoc[0].freeDays" :key="item" :class="`d-inline-block rounded-circle text-muted  border font-weight-bold shadow-sm   date ${(item.on)?'newDate':'bg-white'}`" >{{ item.days }}</div>
                   </div>
                </div>
                <!-- form -->
                    ...
                    <div class="form-group mt-4">
                      <small id="helpId" class="form-text text-muted pl-1">Fix Date</small>
                         <input type="date" class="form-control shadow-sm p-4" placeholder="" id="">
                      <small id="helpId" class="form-text text-danger d-none">Help text</small>
                    </div>

                    <div class="form-group mt-4">
                      <textarea class="form-control shadow-sm p-2" id="" cols="30" rows="7" placeholder="Why do you want to meet the doctor?"></textarea>
                      <small id="helpId" class="form-text text-danger d-none">Help text</small>
                    </div>


               <div class="rating p-2">
                   <i v-for="item in filterDoc[0].rating" :key="item" class="fa fa-star  text-muted " aria-hidden="true"></i> <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                 </div>
